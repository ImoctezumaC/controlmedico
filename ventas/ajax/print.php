		...
		switch ($_GET['action']){
			case 'print_sale':
				...
				foreach ($header as $key){
					...
					$sale_serie = $key['venta_factura'];
					$sale_number = $key['venta_numero'];
					$entity_rfc = $key['cliente_rfc'];
					$entity_social_name = $key['cliente_razon_social'];
					$entity_address = $key['cliente_direccion'];	
				}
				...
				foreach ($detail as $key){
					...
					$sale_detail .= '<tr>
										<td style="border-right:1px solid black;">'.$d_description.'</td>
						         		<td style="border-right:1px solid black;">'.$d_unit.'</td>
				...
				$sale_detail .= '<tr>
									<td colspan="4" align="right" style="border-top:1px solid black; border-right:1px solid black;"><strong>Total</strong></td>
				...
				$html = '<table cellpadding="4px" style="border:1px solid black;">
							...
							<tr>
								<td width="90px"><strong>RFC: </strong></td>
								<td width="232px">'.$entity_rfc.'</td>
				         ...
				         <table cellpadding="4px" style="border:1px solid black;">
				         	<tr>
				         		<td width="242px" style="border-right:1px solid black; border-bottom:1px solid black;"><strong>Descripcion</strong></td>
				         		<td width="80px" style="border-right:1px solid black; border-bottom:1px solid black;"><strong>Unidad</strong></td>
