...
require "conexion.php";
   ...
   $sql="INSERT INTO notaevolucion(fechaReg,idPaciente, servicio,medicamentosP,presentacion, subjetivo, objetivo,signosV,analisis,diagnostico,planManejo,tipoCIE10,pronostico,idEsp,edadPaciente) VALUES('$fechaReg','$idPaciente', '$servicio','$medicamentosP','$presentacion', '$subjetivo', '$objetivo','$signosV','$analisis','$diagnostico','$planManejo','$tipoCIE10','$pronostico','$idEsp',(select ROUND(datediff(current_date,fechNacimiento)/365) FROM dtpaciente where idPaciente='$idPaciente'))";
