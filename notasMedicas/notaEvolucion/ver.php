...
$query="SELECT nombre,apellido1,apellido2,fechNacimiento,sexoPaciente,alergia,tipoAlergia,alcoholismo, tabaquismo, toxicomania,comorbilidades,nombreCompleto, especialidadMed,noCedulaProfesional, notaevolucion.* FROM dtpaciente,notaevolucion,dtpersonal WHERE dtpaciente.idPaciente=notaevolucion.idPaciente AND dtpersonal.idPersonal=notaevolucion.idEsp AND idNota='$id' ";
