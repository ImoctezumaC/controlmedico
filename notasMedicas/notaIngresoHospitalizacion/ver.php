...
$query="SELECT nombre,apellido1,apellido2,fechNacimiento,sexoPaciente,alergia,tipoAlergia,alcoholismo, tabaquismo, toxicomania,comorbilidades,nombreCompleto, especialidadMed,noCedulaProfesional, notaingresohospitalizacion.* FROM dtpaciente,notaingresohospitalizacion,dtpersonal WHERE dtpaciente.idPaciente=notaingresohospitalizacion.idPaciente AND dtpersonal.idPersonal=notaingresohospitalizacion.idEsp AND idNota='$id' ";
...
$pdf->SetFont('Arial','B',9);
$pdf->SetXY(160,50);
$pdf->Cell(15,6,"Servicio:",0,1,'L');
$pdf->SetXY(200,50);
$pdf->SetFont('Arial','',9);
$pdf->Cell(15,6,utf8_decode($row['servicio']),0,1,'C');
