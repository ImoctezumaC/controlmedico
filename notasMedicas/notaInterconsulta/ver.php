...
$query="SELECT nombre,apellido1,apellido2,fechNacimiento,sexoPaciente,alergia,tipoAlergia,alcoholismo, tabaquismo, toxicomania,comorbilidades,nombreCompleto, especialidadMed,noCedulaProfesional, notainterconsulta.* FROM dtpaciente,notainterconsulta,dtpersonal WHERE dtpaciente.idPaciente=notainterconsulta.idPaciente AND dtpersonal.idPersonal=notainterconsulta.idEsp AND idNota='$id' ";
