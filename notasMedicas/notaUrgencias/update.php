...
require "conexion.php";
   ...
   $sql="UPDATE notaurgencias SET  fechaReg='$fechaReg', idPaciente='$idPaciente', numCama='$numCama', medicamentosP='$medicamentosP', presentacion='$presentacion' ,subjetivo='$subjetivo', objetivo='$objetivo',signosV='$signosV', analisis='$analisis',diagnostico='$diagnostico', planManejo='$planManejo', tipoCIE10='$tipoCIE10', pronostico='$pronostico', idEsp='$idEsp' WHERE idNota='$idNota'";
