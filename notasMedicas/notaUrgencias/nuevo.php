...
<head>
  ...
  <?php 
  $titulo='Nota de Urgencias'; //titulo de la pagina
  include("head.php");
?>  
                       ...
                       <div class="col-md-3  form-group" data-for="fechaReg">
                        ...
                        <div class="col-md-4  form-group" data-for="tipoCIE10">
                          ...
                          <label for="tipoCIE10-form1-q" class="form-control-label mbr-fonts-style display-7">CIE 10: </label>
                            ...
                            <p>
                            <select class="selectpicker col-md-12" data-show-subtext="true" name="tipoCIE10" data-live-search="true">
                                <option data-subtext="0">Seleciona...</option>       
                              <?php
                         ...
                         <p>
                            <select class="selectpicker col-md-12" data-show-subtext="true" data-url="data.json">                          
                              </select> 
                          </p>
                        ...
                        <div class="col-md-4  form-group" data-for="idEsp">
                            ...
                            <p>
                            <select class="selectpicker col-md-12" data-show-subtext="true" name="idEsp" data-live-search="true">
                                <option data-subtext="0">Seleciona...</option>       
