...
/* DB table to use */
	$sTable = "notahistoriaclinica";

	$aColumns = array('idNota','fechaReg','idPaciente','numCama','medicamentosP','anteceNP','padeciActual','inteAS','exploFisica','resulPALGO','diagnostico','tipoCie10','pronostico','idEsp');
