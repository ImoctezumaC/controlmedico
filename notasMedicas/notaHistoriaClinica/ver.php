...
$query="SELECT nombre,apellido1,apellido2,fechNacimiento,sexoPaciente,alergia,tipoAlergia,alcoholismo, tabaquismo, toxicomania,comorbilidades,gpoEtnico,heredoFamiliares,nombreCompleto, especialidadMed,noCedulaProfesional, notahistoriaclinica.* FROM dtpaciente,notahistoriaclinica,dtpersonal WHERE dtpaciente.idPaciente=notahistoriaclinica.idPaciente AND dtpersonal.idPersonal=notahistoriaclinica.idEsp AND idNota='$id' ";
...
$pdf->SetFont('Arial','B',9);
$pdf->SetXY(160,50);
$pdf->Cell(15,6,"N. Cama:",0,1,'L');
$pdf->SetXY(200,50);
$pdf->SetFont('Arial','',9);
$pdf->Cell(15,6,$row['numCama'],0,1,'C');
...
$pdf->SetXY(130,55);
$pdf->SetFont('Arial','',9);
$pdf->Cell(20,6,$row['fechaReg'],0,1,'C');
...
$pdf->SetXY(190,55);
$pdf->SetFont('Arial','',9);
$pdf->Cell(70,6,$row['comorbilidades'],0,1,'C');



$pdf->SetFont('Arial','B',9);
$pdf->SetXY(10,60);
$pdf->Cell(15,6,utf8_decode("grupo Étnico:"),0,1,'L');
$pdf->SetXY(30,60);
$pdf->Cell(15,6,$row['gpoEtnico'],0,1,'C');


$pdf->SetFont('Arial','B',9);
$pdf->SetXY(100,60);
$pdf->Cell(15,6,"Antecedentes heredofamiliares:",0,1,'L');
$pdf->SetXY(160,60);
$pdf->Cell(15,6,$row['heredoFamiliares'],0,1,'C');
...
$pdf->SetXY(57,70);
$pdf->SetFont('Arial','',9);
$pdf->Cell(39,6,utf8_decode($row['tipoAlergia']),1,1,'C');
...
$pdf->SetXY(10,95);
$pdf->Cell(15,6,utf8_decode("Antecedentes no patológicos:"),0,1,'L');
$pdf->SetXY(10,100);
$pdf->Cell(250,24,$row['anteceNP'],1,1,'L');

$pdf->SetXY(10,125);
$pdf->Cell(20,6,"Padecimiento actual:",0,1,'L');
$pdf->SetXY(10,130);
$pdf->Cell(250,24,$row['padeciActual'],1,1,'L');


$pdf->SetXY(10,155);
$pdf->Cell(10,6,"Interrogatorio por aparatos y sistemas:",0,1,'L');
$pdf->SetXY(10,160);
$pdf->Cell(250,24,$row['inteAS'],1,1,'L');
...
$pdf->addPage();
$pdf->SetXY(10,40);
$pdf->Cell(15,6,utf8_decode("Exploración física:"),0,1,'L');
$pdf->SetXY(10,45);
$pdf->Cell(250,18,$row['exploFisica'],1,1,'L');

$pdf->SetXY(10,70);
$pdf->Cell(15,6,utf8_decode("Resultados previos y actuales de Lab., gabinete y otros:"),0,1,'L');
$pdf->SetXY(10,75);
$pdf->Cell(250,24,$row['resulPALGO'],1,1,'L');
...
$pdf->Cell(15,6,utf8_decode($row['nombreCompleto']),0,0,'L');

$pdf->SetXY(110,180);
//$pdf->Cell(15,6,"Especialidad:",0,1,'L');
$pdf->Cell(15,6,utf8_decode($row['especialidadMed']),0,0,'L');
