...
<head>
  ...
  <?php 
  $titulo='Nota de ingreso hospitalizacion'; //titulo de la pagina
  include("head.php");
?>  
                    ...
                    <div class="dragArea row row-sm-offset">
                         ...
                         <div class="col-md-5  form-group" data-for="nombre">
                            ...
                            <select class="selectpicker col-md-12" data-show-subtext="true" name="idPaciente" data-live-search="true">
                              ...
                              $con = mysqli_connect("localhost","root","root","medicaldb");
...
onblur ="document.getElementById('nombre').value=this.value" -->
                       ...
                       <div class="col-md-4  form-group" data-for="numCama">
                            <label for="numCama-form1-q" class="form-control-label mbr-fonts-style display-7">Número de cama</label>
                            <input type="text" name="numCama" data-form-field="numCama"  class="form-control display-7" id="numCama-form1-q">
                        </div>   
                       ...
                       <div class="col-md-3  form-group" data-for="fechaReg">
                        ...
                        <div data-for="anteceNP" class="col-md-3 form-group">
                            <label for="anteceNP-form1-q" class="form-control-label mbr-fonts-style display-7">Antecedentes no patológicos:</label>
                            <textarea name="anteceNP" data-form-field="anteceNP" class="form-control display-7" id="anteceNP-form1-q"></textarea>
                        </div>
                        <div data-for="padeciActual" class="col-md-4 form-group">
                            ...
                            <textarea name="padeciActual" data-form-field="padeciActual" class="form-control display-7" id="padeciActual-form1-q"></textarea>
                        </div>
                        
                        <div data-for="inteAS" class="col-md-4 form-group">
                            <label for="inteAS-form1-q" class="form-control-label mbr-fonts-style display-7">Interrogativo por aparatos y sistemas:</label>
                            <textarea name="inteAS" data-form-field="inteAS" class="form-control display-7" id="inteAS-form1-q"></textarea>
                        </div>
                        ...
                        <div data-for="exploFisica" class="col-md-4 form-group">
                            ...
                            <textarea name="exploFisica" data-form-field="exploFisica" class="form-control display-7" id="exploFisica-form1-q"></textarea>
                        </div>
                        ...
                        <div data-for="resulPALGO" class="col-md-4 form-group">
                            ...
                            <textarea name="resulPALGO" data-form-field="resulPALGO" class="form-control display-7" id="resulPALGO-form1-q"></textarea>
                        </div>
