...
$coloresp='#FF8C00';
$sql = "SELECT id, title, color,start, end,  telefono, confirmado FROM events WHERE color='$coloresp'";
    ...
    <div class="container">
		...
		<div class="modal fade" id="ModalEdit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		  <div class="modal-dialog" role="document">
			...
			<form class="form-horizontal" method="POST" action="expediente/index.php">
